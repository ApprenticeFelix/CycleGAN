...
def load_data(nr_of_channels, batch_size=1, nr_T_train_imgs=None, nr_S1_train_imgs=None, nr_S2_train_imgs=None, nr_S3_train_imgs=None,
              nr_T_test_imgs=None, nr_S1_test_imgs=None, nr_S2_test_imgs=None, nr_S3_test_imgs=None, subfolder='',
              generator=False, D_model=None, use_multiscale_discriminator=False, use_supervised_learning=False, REAL_LABEL=1.0):
    data_path = '/home/william/Jan_GAN'

    trainT_path = os.path.join(data_path, subfolder, 'trainT')
    trainS1_path = os.path.join(data_path, subfolder, 'trainS1')
    trainS2_path = os.path.join(data_path, subfolder, 'trainS2')
    trainS3_path = os.path.join(data_path, subfolder, 'trainS3')
    testT_path = os.path.join(data_path, subfolder, 'testT')
    testS1_path = os.path.join(data_path, subfolder, 'testS1')
    testS2_path = os.path.join(data_path, subfolder, 'testS2')
    testS3_path = os.path.join(data_path, subfolder, 'testS3')
    trainT_image_names = os.listdir(trainT_path)
    if nr_T_train_imgs != None:
        trainT_image_names = trainT_image_names[:nr_T_train_imgs]
    ...
    if nr_T_test_imgs != None:
        testT_image_names = testT_image_names[:nr_T_test_imgs]
